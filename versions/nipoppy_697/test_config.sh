...
TEST_COMMAND="pytest tests/test_zenodo_api.py tests/test_workflow_zenodo.py tests/test_workflow_pipeline_store_install.py tests/test_workflow_pipeline_store_search.py tests/test_cli.py -v --durations=0"
