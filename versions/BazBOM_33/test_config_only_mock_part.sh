...
TEST_COMMAND="python3 -m pytest tools/supplychain/tests/test_enrichment_integration.py::TestEnrichmentEdgeCases::test_findings_with_invalid_cvss_scores --durations=0 -v"
