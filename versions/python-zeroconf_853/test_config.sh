#!/bin/bash
# Test configuration for python-zeroconf_853
# This file is sourced by run_tests_venv_generic.sh

# Test command to run
TEST_COMMAND="python -m pytest tests/test_init.py --durations=0"
