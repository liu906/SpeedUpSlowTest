...
# Usage: ./run_tests_venv_generic.sh <project_name> [number_of_runs] [folder1] [folder2] [suffix]
# Example: ./run_tests_venv_generic.sh autosubmit_2367 5
# Example: ./run_tests_venv_generic.sh bilby_986 10 before after_mock
# Example: ./run_tests_venv_generic.sh bilby_986 10 before after_mock mock
